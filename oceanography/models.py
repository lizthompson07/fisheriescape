...
class Bottle(models.Model):
    ...
    date_time_UTC = models.DateTimeField(null=True, blank=True)
    sounding_m = models.FloatField(null=True, blank=True)
    bottle_depth_m = models.FloatField(null=True, blank=True)
    temp_c = models.FloatField(null=True, blank=True)
    sal_ppt = models.FloatField(null=True, blank=True)
    ph = models.FloatField(null=True, blank=True)
    lat_DDdd = models.FloatField(null=True, blank=True)
    long_DDdd = models.FloatField(null=True, blank=True)
