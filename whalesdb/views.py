...
class IndexView(TemplateView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        context['section'] = [
            ...
            {
                'title': 'Code Table Entry Applications',
                'forms': [
                    {
                        'type': 'codelist',
...
class CreateHydrophone(CreateTemplate):
...
class CreateRecorder(CreateTemplate):
...
class DetailsRecorder(DetailView):
    template_name = "whalesdb/details_eqr_recorder.html"
    ...
    def get_context_data(self, **kwargs):
        ...
        labels = forms.get_labels(models.EcpChannelProperties)
...
class DetailsHydrophone(DetailView):
    template_name = "whalesdb/details_eqr_recorder.html"
...
class ListMakeModel(FilterView):
...
class ListRecorder(ListMakeModel):
...
class ListHydrophone(ListMakeModel):
    template_name = 'whalesdb/filter_inventory.html'
    model = models.EqhHydrophoneProperties
