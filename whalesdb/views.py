...
from shared_models.views import CommonCreateView, CommonUpdateView, CommonFilterView
...
class CommonUpdate(CommonUpdateView):
...
class CommonList(CommonFilterView):
