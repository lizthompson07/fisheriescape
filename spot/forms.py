...
class ProjectForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'funding_sources': forms.SelectMultiple(choices=choices.FUNDING_SOURCES, attrs=attr_chosen),
            ...
            'DFO_project_authority': forms.Select(attrs=attr_chosen),
            'DFO_area_chief': forms.Select(attrs=attr_chosen),
            'DFO_aboriginal_AAA': forms.Select(attrs=attr_chosen),
            'DFO_resource_manager': forms.Select(attrs=attr_chosen),
            'first_nation': forms.Select(attrs=attr_chosen),
            'first_nations_contact': forms.Select(attrs=attr_chosen),
            'DFO_technicians': forms.Select(attrs=attr_chosen),
