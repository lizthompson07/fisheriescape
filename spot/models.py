...
class ProjectDevelopmentStage(UnilingualSimpleLookup):
    pass
...
class Method(models.Model):
    ...
    document_category = models.ForeignKey(DocumentCategory, default=None, on_delete=models.DO_NOTHING, blank=True, null=True, verbose_name=_("document category"))
    document_topic = models.ForeignKey(DocumentTopic, default=None, on_delete=models.DO_NOTHING, blank=True, null=True, verbose_name=_("document topic"))
    ...
    #DATABASE?
    database = models.ForeignKey(Database, default=None, on_delete=models.DO_NOTHING, blank=True, null=True, verbose_name=_("database"))
    #######

    method_category = models.ForeignKey(MethodCategory, default=None, on_delete=models.DO_NOTHING, null=True, blank=True, verbose_name=_("method category"))
    method_type = models.ForeignKey(SpecificMethodType, default=None, on_delete=models.DO_NOTHING, null=True, blank=True, verbose_name=_("specific method type"))
    form_name = models.CharField(max_length=255, null=True, blank=True, verbose_name=_("form name"))
    region = models.ForeignKey(Region, default=None, on_delete=models.DO_NOTHING, null=True, blank=True, verbose_name=_("region"))
    form_category = models.ForeignKey(FormCategory, default=None, on_delete=models.DO_NOTHING, null=True, blank=True, verbose_name=_("form category"))
...
class DatabasesUsed(models.Model):
    database = models.ForeignKey(Database, default=None, on_delete=models.DO_NOTHING, blank=True, null=True, verbose_name=_("database"))
    analysis_program = models.ForeignKey(AnalysisProgramUsed, default=None, on_delete=models.DO_NOTHING, null=True, blank=True, verbose_name=_("analysis program used"))
    models_used = models.ForeignKey(ModelsUsed, default=None, on_delete=models.DO_NOTHING, null=True, blank=True, verbose_name=_("models used"))
    data_format = models.ForeignKey(DataFormat, default=None, on_delete=models.DO_NOTHING, null=True, blank=True, verbose_name=_("data format"))
    ...
    data_quality = models.ForeignKey(DataQuality, default=None, on_delete=models.DO_NOTHING, blank=True, null=True, verbose_name=_("data quality"))
    date_last_modified = models.DateTimeField(blank=True, null=True, default=timezone.now, verbose_name=_("date last modified"))
...
class Organization(models.Model):
    ...
    province = models.ForeignKey(shared_models.Province, on_delete=models.DO_NOTHING, blank=True, null=True,
                                 verbose_name=_("province"), related_name="organization_province")
    ...
    last_modified_by = models.ForeignKey(User, on_delete=models.DO_NOTHING, blank=True, null=True,
                                         verbose_name=_("last modified by"), related_name="organization_last_modified_by")
...
class Person(models.Model):
    ...
    organization = models.ManyToManyField(Organization, through="OrganizationMember", verbose_name=_("membership"),
                                           blank=True)
...
class Objective(models.Model):
    ...
    objective_category = models.ForeignKey(ObjectiveCategory, default=None, on_delete=models.DO_NOTHING, blank=True, null=True, verbose_name=_("Objective Category"))
    ...
    sample_type = models.ForeignKey(SampleType, default=None, on_delete=models.DO_NOTHING, verbose_name=_("sample type/specific data item"))
    salmon_stage = models.ForeignKey(SalmonStage, default=None, on_delete=models.DO_NOTHING, blank=True, null=True, verbose_name=_("salmon stage"))
    ...
    outcomes_category = models.ForeignKey(OutcomeCategory, default=None, on_delete=models.DO_NOTHING, null=True, blank= True, verbose_name=_("outcomes category"))
    outcomes_deadline = models.DateField(blank=True, null=True, verbose_name=_("outcomes deadline"))
    outcomes_contact = models.ForeignKey(Person, on_delete=models.DO_NOTHING, blank=True, null=True, verbose_name=_("Outcomes Contact"))

    date_last_modified = models.DateTimeField(blank=True, null=True, default=timezone.now, verbose_name=_("date last modified"))
    data_quality_type = models.ForeignKey(DataQualityType, default=None, on_delete=models.DO_NOTHING, blank=True, null=True, verbose_name=_("data quality type"))
    data_quality_level = models.ForeignKey(DataQualityLevel, default=None, on_delete=models.DO_NOTHING, blank=True, null=True, verbose_name=_("data quality level"))
...
class OrganizationMember(models.Model):
    ...
    role = models.ForeignKey(Role, default=None, on_delete=models.DO_NOTHING, related_name="members", blank=True, null=True,
                             verbose_name=_("role"))
    date_last_modified = models.DateTimeField(blank=True, null=True, default=timezone.now, verbose_name=_("date last modified"))
    last_modified_by = models.ForeignKey(User, on_delete=models.DO_NOTHING, blank=True, null=True, verbose_name=_("last modified by"), related_name="ml_models_organizationmember_last_modified_by")
...
class Project(models.Model):
    ...
    agreement_lineage = models.ForeignKey(AgreementLineage, default=None, on_delete=models.DO_NOTHING, null=True, blank=True, verbose_name=_("agreement lineage"))
    agreement_database = models.ForeignKey(AgreementDatabase, default=None, on_delete=models.DO_NOTHING, null=True, blank=True, verbose_name=_("agreement database"))
    agreement_status = models.ForeignKey(AgreementStatus, default=None, on_delete=models.DO_NOTHING, blank=True, null=True, verbose_name=_("agreement status"))
    agreement_status_comment = models.TextField(max_length=1000, null=True, blank=True, verbose_name=_("agreement status comment"))

    funding_sources = models.ForeignKey(FundingSource, default=None, on_delete=models.DO_NOTHING, null=True, blank=True, verbose_name=_("funding sources"))
    funding_years = models.ForeignKey(FundingYear, default=None, on_delete=models.DO_NOTHING, null=True, blank=True, verbose_name=_("funding year"))
    ...
    watershed = models.ForeignKey(WaterShed, default=None, on_delete=models.DO_NOTHING, blank=True, null=True, verbose_name=_("watershed"))
    primary_river = models.ManyToManyField(River, blank=True, null=True, verbose_name=_("primary river"))
    secondary_river = models.ManyToManyField(River, blank=True, null=True, verbose_name=_("secondary river"))
    ...
    target_species = models.ForeignKey(Species, default=None, on_delete=models.DO_NOTHING, blank=True, null=True, verbose_name=_("target species"))
    salmon_life_cycle = models.ForeignKey(SalmonLifeCycle, default=None, on_delete=models.DO_NOTHING, null=True, blank=True, verbose_name=_("salmon life cycle"))


    #Project type
    project_type = models.ForeignKey(ProjectType, default=None, on_delete=models.DO_NOTHING, blank=True, null=True, verbose_name=_("project type"))
    project_sub_type = models.ForeignKey(ProjectSubType, default=None, on_delete=models.DO_NOTHING, blank=True, null=True, verbose_name=_("project sub type"))
    project_class = models.ForeignKey(ProjectClass, default=None, on_delete=models.CASCADE, blank=True, null=True, verbose_name=_("project class"))
    project_component = models.ForeignKey(ProjectComponent, default=None, on_delete=models.CASCADE, blank=True, null=True, verbose_name=_("project component"))
    project_development_stage = models.ForeignKey(ProjectDevelopmentStage, default=None, on_delete=models.CASCADE, blank=True, null=True, verbose_name=_("project development stage"))

    #URL FIELDS?
    DFO_link = models.URLField(blank=True, null=True, verbose_name=_("other DFO project link"))
    non_DFO_link = models.URLField(blank=True, null=True, verbose_name=_("other non-DFO project link"))
...
class ProjectPerson(models.Model):
    ...
    person = models.ForeignKey(Person, on_delete=models.DO_NOTHING, related_name="project_people")
    role = models.ForeignKey(Role, default=None, on_delete=models.DO_NOTHING, null=True, blank=True, related_name="project_people")
...
class Project(models.Model):
    ...
    organization = models.ForeignKey(Organization, on_delete=models.DO_NOTHING, related_name="projects")
    ...
    submission_accepted = models.BooleanField(default=False, verbose_name=_("was the submission accepted?"))
    ...
    people = models.ManyToManyField(Person, through="ProjectPerson", blank=True)
...
class ContributionAgreementChecklist(models.Model):
    ...
    risk_assessment_complete = models.BooleanField(default=False,
                                                   verbose_name=_("The risk assessment has been completed/approved and posted to PATH"))
    correct_clause_selected = models.BooleanField(default=False,
                                                  verbose_name=_(
                                                      "The clauses selected in the CA reflect the risk level and contribution amount"))
    formatting_correct = models.BooleanField(default=False, verbose_name=_("There are no hanging/orphan lines/titles"))
    amounts_correct = models.BooleanField(default=False, verbose_name=_(
    ...
    clear_language = models.BooleanField(default=False,
                                         verbose_name=_(
                                             "Schedule 5: Language is clear, concise and can be generally understood by someone who is not a specialist"))
    acronyms_defined = models.BooleanField(default=False, verbose_name=_("Schedule 5: Acronyms are defined upon first use"))
    activities_elibigle = models.BooleanField(default=False, verbose_name=_("Schedule 5: All Activities/tasks are eligible"))
    detail_commensurate_with_budget = models.BooleanField(default=False,
                                                          verbose_name=_(
                                                              "Schedule 5: The level of detail for each Activity (i.e., task description) is commensurate with its budget"))
    realistic_timeframe = models.BooleanField(default=False,
                                              verbose_name=_(
                                                  "Schedule 5: Each Activity can be reasonably expected to be completed within its accorded timeframe"))
    key_tasks_outlined = models.BooleanField(default=False,
                                             verbose_name=_(
                                                 "Schedule 5: All key tasks required to be undertaken for each Activity to be achieved are outlined"))
    deliverables = models.BooleanField(default=False, verbose_name=_(
    ...
    project_budgets_adds_up = models.BooleanField(default=False,
                                                  verbose_name=_(
                                                      "Schedule 5: The sum of all individual project Activity budgets adds up to the agreement total"))
    sufficient_budget_detail = models.BooleanField(default=False,
                                                   verbose_name=_(
                                                       "Schedule 5: Sufficient budget details have been provided to confirm that the costs are eligible and reasonable"))
    expenses_eligible = models.BooleanField(default=False, verbose_name=_("Schedule 5: All expenses are eligible"))
    reasonable_costs = models.BooleanField(default=False, verbose_name=_("Schedule 5: All costs are reasonable"))
    budget_adds_up = models.BooleanField(default=False, verbose_name=_("Schedule 5: The budget adds up correctly."))
    maximum_amounts_set = models.BooleanField(default=False, verbose_name=_(
        "Schedule 5: If applicable, maximum amounts for expense categories have been set (i.e., identified with an asterisk (*))."))
    budget_reflects_activity = models.BooleanField(default=False,
                                                   verbose_name=_("Schedule 5: The budget reflects the nature of the Activity(ies)."))
    stacking_limits_respected = models.BooleanField(default=False,
                                                    verbose_name=_(
                                                        "Schedule 5: The federal and stacking limit have been respected, based on confirmed funding."))
    no_funding_redundancy = models.BooleanField(default=False, verbose_name=_(
    ...
    stacking_identified = models.BooleanField(default=False, verbose_name=_(
    ...
    confirmation_letters_2_path = models.BooleanField(default=False, verbose_name=_(
    ...
    financial_information_2_path = models.BooleanField(default=False,
                                                       verbose_name=_(
                                                           "Schedule 5: Financial information has been updated/entered in PATH as per Data Entry Procedures"))
    conflict_of_interest_assessed = models.BooleanField(default=False, verbose_name=_(
    ...
    # Schedule 6
    cashflow_adds_up = models.BooleanField(default=False,
                                           verbose_name=_(
                                               "Schedule 6: The cash flow adds up correctly and reflects the timing of Activities."))
    # Schedule 7
    pre_filled_sched7 = models.BooleanField(default=False, verbose_name=_("Schedule 7: is pre-filled and mirrors Schedule 5"))
    performance_measures_in_path = models.BooleanField(default=False, verbose_name=_(
    ...
    # General
    team_leader_reviewed = models.BooleanField(default=False, verbose_name=_("The Team Leader has reviewed and approves the CA"))
...
class ExpressionOfInterest(models.Model):
    ...
    project_eligible = models.BooleanField(default=False, verbose_name=_("is the project eligible?"))
...
class ProjectYear(models.Model):
    ...
    lapsing_funds = models.BooleanField(default=False, )
    lapsing_funds_nhq_notified = models.DateTimeField(blank=True, null=True)
    funding_recovery_needed = models.BooleanField(default=False, )
    funding_recovery_email_sent = models.DateTimeField(blank=True, null=True)
    funds_recovered = models.BooleanField(default=False, )
...
class ReportChecklist(models.Model):
    ...
    # Schedule 7 - General
    sounds_sched7 = models.BooleanField(default=False,
                                        verbose_name=_(
                                            "Schedule 7 matches the one in the signed CA and all sections have been duly filled in."))
    accurate_reporting_period = models.BooleanField(default=False, verbose_name=_(
    ...
    no_missing_period = models.BooleanField(default=False, verbose_name=_(
    ...
    matching_funds = models.BooleanField(default=False,
                                         verbose_name=_("The “RFCPP funds received year to date” matches the amount in RFCPP records."))
    summed_correctly = models.BooleanField(default=False, verbose_name=_("Amounts in Table 1.1 are summed correctly."))
    budgeted_amounts_not_exceeded = models.BooleanField(default=False,
                                                        verbose_name=_(
                                                            "Claimed expenses for expense categories tagged with an asterisk (*) do not exceed the budgeted amount."))
    tab11_no_issues = models.BooleanField(default=False, verbose_name=_(
    ...
    reimbursable_taxes_not_claimed = models.BooleanField(default=False,
                                                         verbose_name=_(
                                                             "Reimbursable taxes have not been claimed (see application form for percentages reimbursable)."))
    tab12_filled = models.BooleanField(default=False, verbose_name=_(
    ...
    confirmation_letters = models.BooleanField(default=False, verbose_name=_(
    ...
    support_matches = models.BooleanField(default=False, verbose_name=_(
    ...
    actuals_entered = models.BooleanField(default=False,
                                          verbose_name=_(
                                              "All financial information has been entered in the ‘Actual’ section of the financial tab in PATH."))

    # Schedule 7 – Section 2
    deliverables_check_out = models.BooleanField(default=False,
                                                 verbose_name=_(
                                                     "The status of deliverables matches the claimed expenses and timing of Activities in Schedule 5."))
    invoices_check_out = models.BooleanField(default=False, verbose_name=_(
    ...
    sufficient_detail = models.BooleanField(default=False, verbose_name=_(
    ...
    tab22_complete = models.BooleanField(default=False, verbose_name=_(
    ...
    compliant_signage = models.BooleanField(default=False, verbose_name=_("RFCPP signage follows the RFCPP-FIP Guidelines"))

    # Schedule 7 – Section 3
    tab31_actuals = models.BooleanField(default=False,
                                        verbose_name=_("The “actuals” in Table 3.1 align with the activities and budget table."))
    tab32_complete = models.BooleanField(default=False, verbose_name=_(
    ...
    section3_path_recored = models.BooleanField(default=False,
                                                verbose_name=_(
                                                    "All information provided in Section 3 has been recorded in PATH (for final/annual reports only)."))

    # Schedule 7 – Section 4
    section4_signed = models.BooleanField(default=False, verbose_name=_(
        "Section 4 has been signed by an authorised representative of the Recipient (does not need to be the CA signatory)."))

    # Regional Approval
    sched7_to_path = models.BooleanField(default=False,
                                         verbose_name=_(
                                             "Schedule 7 and all supporting documents (e.g., deliverables) have been posted to PATH."))
    sched6_to_path = models.BooleanField(default=False,
                                         verbose_name=_(
                                             "If a multi-year agreement, Schedule 6 for next year has been received and posted to PATH."))
    site_visit_summary_provided = models.BooleanField(default=False,
                                                      verbose_name=_(
                                                          "If a site visit was completed for the CA, a summary thereof is provided in the comments section below."))
    team_leader_reviewed = models.BooleanField(default=False,
                                               verbose_name=_(
                                                   "The Team Leader has reviewed and approved the recipient report and recommends payment."))
...
class Site(models.Model):
    ...
    long = models.FloatField(max_length=255, verbose_name=_("longitude (DD.dddddd)"), blank=True, null=True,
                             validators=[MaxValueValidator(0), ])
    restoration_type = models.ForeignKey(RestorationType, on_delete=models.DO_NOTHING, related_name="sites",
                                         verbose_name=_("restoration type (optional)"), blank=True, null=True)
...
class SiteVisit(models.Model):
    ...
    c1 = models.BooleanField(default=False, verbose_name=_(
    ...
    c2 = models.BooleanField(default=False, verbose_name=_(
    ...
    c3 = models.BooleanField(default=False, verbose_name=_("C.3 Was the sign installed?  If not, provide details."))
    c3_comment = models.CharField(max_length=500, blank=True, null=True, verbose_name=_("C.3 comments"))

    c4 = models.BooleanField(default=False, verbose_name=_("C.4 Were photos taken? If so, ensure that photos are posted to PATH."))
    c4_comment = models.CharField(max_length=500, blank=True, null=True, verbose_name=_("C.4 comments"))

    c5 = models.BooleanField(default=False, verbose_name=_(
    ...
    c6 = models.BooleanField(default=False, verbose_name=_(
    ...
    c7 = models.BooleanField(default=False,
                             verbose_name=_("C.7 Were the structure(s)/works designed/installed properly?  If not, provide details."))
    ...
    c8 = models.BooleanField(default=False,
                             verbose_name=_(
                                 "C.8 Did the work address the key issues at the site / is it functioning as intended? If not, provide details."))
    c8_comment = models.CharField(max_length=500, blank=True, null=True, verbose_name=_("C.8 comments"))

    c9 = models.BooleanField(default=False, verbose_name=_("C.9 Are recreational fish using the site/have access to the site?"))
    ...
    c10 = models.BooleanField(default=False,
                              verbose_name=_("C.10 Are there concerns with any aspect of the work? If yes, provide details."))
    c10_comment = models.CharField(max_length=500, blank=True, null=True, verbose_name=_("C.10 comments"))

    c11 = models.BooleanField(default=False, verbose_name=_("C.11 Were any suggestions made for future projects? If yes, provide details."))
...
class Payment(models.Model):
    ...
    materials_submitted = models.BooleanField(default=False, verbose_name=_("were all necessary materials submitted?"))
    nhq_notified = models.DateTimeField(blank=True, null=True, verbose_name=_("NHQ notified"))
    payment_confirmed = models.BooleanField(default=False, verbose_name=_("has the payment been confirmed?"))
