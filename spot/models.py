...
class Method(models.Model):
    ...
    field_work_method_type = models.CharField(max_length=255, default=None, blank=True, null=True, verbose_name=_("Field Work Methods Type"))
    planning_method_type = models.CharField(max_length=255, default=None, blank=True, null=True, verbose_name=_("Planning Method Type"))
    sample_processing_method_type = models.CharField(max_length=255, default=None, blank=True, null=True, verbose_name=_("Sample Processing Method Type"))
...
class Data(models.Model):
    ...
    species = models.CharField(max_length=255, default=None, null=True, blank=True, verbose_name=_("Species"))
    ...
    samples_collected_database = models.CharField(max_length=255, default=None, null=True, blank=True, verbose_name=_("Sample Collected Database"))
...
class Objective(models.Model):
    ...
    species = models.CharField(max_length=500, default=None, blank=True, null=True, verbose_name=_("Species"))
...
class Project(models.Model):
    ...
    management_area = models.PositiveIntegerField(null=True, blank=True, validators=[MinValueValidator(0), MaxValueValidator(142)])
    ...
    species = models.CharField(max_length=255, null=True, default=None, blank=True, verbose_name=_("Target Species"))
    ...
    project_sub_type = models.CharField(max_length=255, default=None, blank=True, null=True, verbose_name=_("Project Sub Type"))
    project_theme = models.CharField(max_length=255, default=None, blank=True, null=True, verbose_name=_("Project Theme"))
    ...
    core_component = models.CharField(max_length=255, blank=True, null=True, verbose_name=_("Core Component"))
    supportive_component = models.CharField(max_length=255, blank=True, null=True, verbose_name=_("Supportive Component"))
