...
class ObservationPlatform(models.Model):
    platform_name = models.CharField(max_length=250, blank=True, null=True)

class MediaDataPath(models.Model):
    ...
    platform = models.ForeignKey(ObservationPlatform, on_delete=models.DO_NOTHING, related_name="media_data_paths", verbose_name=_("platform"))
