# Generated by Django 2.2.2 on 2020-04-29 02:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visitor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pageviews', to='tracking.Visitor')),
            ],
            options={
                'ordering': ('-view_time',),
            },
