...
class StaffFilter(django_filters.FilterSet):
    ...
    division = django_filters.ChoiceFilter(field_name='project__section__division', lookup_expr='exact', label=_("Division"))
    section = django_filters.ChoiceFilter(field_name='project__section', lookup_expr='exact', label=_("Section"))
    submitted = django_filters.ChoiceFilter(field_name='project__submitted', lookup_expr='exact', label=_("Submitted?"))
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.filters['submitted'] = django_filters.ChoiceFilter(field_name='project__submitted', lookup_expr='exact', choices=yes_no_choices)
        self.filters['section'] = django_filters.ChoiceFilter(field_name="project__section", label=_("Section"),
                                                              lookup_expr='exact', choices=section_choices)
        self.filters['region'] = django_filters.ChoiceFilter(field_name="project__section__division__branch__region", label=_("Region"),
                                                              lookup_expr='exact', choices=region_choices)
        self.filters['division'] = django_filters.ChoiceFilter(field_name="project__section__division", label=_("Division"),
                                                             lookup_expr='exact', choices=division_choices)
        # self.filters['division'] = django_filters.ChoiceFilter(field_name='section__division', lookup_expr='exact', choices=div_choices)
