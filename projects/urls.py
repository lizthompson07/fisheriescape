...
urlpatterns = [
    ...
    path('reports/sara-report/fiscal-year/<int:fiscal_year>/regions/<str:regions>/divisions/<str:divisions>/sections/<str:sections>',
         views.PDFSaraReport.as_view(), name="pdf_sara"),
    path('reports/sara-report/fiscal-year/<int:fiscal_year>/funding/<str:funding>/regions/<str:regions>/divisions/<str:divisions>/sections/<str:sections>/',
         views.sara_spreadsheet, name="xls_sara"),
