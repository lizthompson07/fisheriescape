...
def generate_master_spreadsheet(fiscal_year, regions, divisions, sections, user=None):
    ...
    if len(project_list) == 0:
        ...
        header = [
            ...
            verbose_field_name(project_list.first(), 'data_products'),
            verbose_field_name(project_list.first(), 'data_storage'),
            verbose_field_name(project_list.first(), 'open_data_eligible'),
            ...
            verbose_field_name(project_list.first(), 'other_lab_support_needs'),
