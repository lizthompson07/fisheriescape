...
def digest_data():
    smb_tag = models.Tag.objects.get_or_create(name="Smallmouth Bass (SMB)")[0]
    sar_tag = models.Tag.objects.get_or_create(name="Species at Risk (SAR)")[0]
    ais_tag = models.Tag.objects.get_or_create(name="Aquatic Invasive Species (AIS)")[0]
