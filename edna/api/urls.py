...
router.register(r'filters-lite', views.FilterLiteViewSet)
router.register(r'extracts', views.DNAExtractViewSet)
router.register(r'extracts-lite', views.DNAExtractLiteViewSet)
router.register(r'pcrs', views.PCRViewSet)
router.register(r'pcrs-lite', views.PCRLiteViewSet)
