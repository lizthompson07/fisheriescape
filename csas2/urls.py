...
urlpatterns = [
    ...
    # permissions
    path('settings/users/', views.CSASAdminUserFormsetView.as_view(), name="manage_csas_admin_users"),
    path('settings/users/<int:pk>/delete/', views.CSASAdminUserHardDeleteView.as_view(), name="delete_csas_admin_user"),
    # tags
