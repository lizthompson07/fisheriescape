...
class CSASRequestForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        coordinator_choices = [(u.user.id, u.user.get_full_name()) for u in models.CSASAdminUser.objects.filter(region__isnull=False).order_by("user__first_name", "user__last_name")]
