...
#         ]
#
#         self.test_urls = [reverse_lazy("csas2:" + name) for name in self.test_url_names]
#         self.test_views = [
#             views.FiltrationTypeFormsetView,
#             views.DNAExtractionProtocolFormsetView,
#             views.TagFormsetView,
#         ]
#         self.expected_template = 'csas2/formset.html'
...
#             new_d["obj"] = obj
#             new_d["url"] = reverse_lazy("csas2:" + d["url_name"], kwargs={"pk": obj.id})
