...
class TestCollectionCreateView(CommonTest):
    def setUp(self):
        super().setUp()
        self.test_url = reverse_lazy('csas2:collection_new')
        self.expected_template = 'csas2/form.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        ...
        self.assert_correct_url("csas2:collection_new", f"/en/csas2/collections/new/")
...
class TestCollectionDeleteView(CommonTest):
    def setUp(self):
        ...
        self.test_url = reverse_lazy('csas2:collection_delete', args=[self.instance.pk, ])
        self.expected_template = 'csas2/confirm_delete.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:collection_delete", f"/en/csas2/collections/{self.instance.pk}/delete/", [self.instance.pk])
...
class TestCollectionDetailView(CommonTest):
    def setUp(self):
        super().setUp()
        self.instance = FactoryFloor.CollectionFactory()
        self.test_url = reverse_lazy('csas2:collection_detail', args=[self.instance.pk, ])
        self.expected_template = 'csas2/collection_detail.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:collection_detail", f"/en/csas2/collections/{self.instance.pk}/view/", [self.instance.pk])


class TestCollectionListView(CommonTest):
    def setUp(self):
        super().setUp()
        self.test_url = reverse_lazy('csas2:collection_list')
        self.expected_template = 'csas2/list.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:collection_list", f"/en/csas2/collections/")
...
class TestCollectionUpdateView(CommonTest):
    def setUp(self):
        super().setUp()
        self.instance = FactoryFloor.CollectionFactory()
        self.test_url = reverse_lazy('csas2:collection_edit', args=[self.instance.pk, ])
        self.expected_template = 'csas2/form.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:collection_edit", f"/en/csas2/collections/{self.instance.pk}/edit/", [self.instance.pk])


class TestExtractionBatchCreateView(CommonTest):
    def setUp(self):
        super().setUp()
        self.test_url = reverse_lazy('csas2:extraction_batch_new')
        self.expected_template = 'csas2/form.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:extraction_batch_new", f"/en/csas2/extractions/new/")
...
class TestExtractionBatchDeleteView(CommonTest):
    def setUp(self):
        ...
        self.test_url = reverse_lazy('csas2:extraction_batch_delete', args=[self.instance.pk, ])
        self.expected_template = 'csas2/confirm_delete.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:extraction_batch_delete", f"/en/csas2/extractions/{self.instance.pk}/delete/", [self.instance.pk])
...
class TestExtractionBatchDetailView(CommonTest):
    def setUp(self):
        super().setUp()
        self.instance = FactoryFloor.ExtractionBatchFactory()
        self.test_url = reverse_lazy('csas2:extraction_batch_detail', args=[self.instance.pk, ])
        self.expected_template = 'csas2/extraction_batch_detail.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:extraction_batch_detail", f"/en/csas2/extractions/{self.instance.pk}/view/", [self.instance.pk])


class TestExtractionBatchListView(CommonTest):
    def setUp(self):
        super().setUp()
        self.test_url = reverse_lazy('csas2:extraction_batch_list')
        self.expected_template = 'csas2/list.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:extraction_batch_list", f"/en/csas2/extractions/")
...
class TestExtractionBatchUpdateView(CommonTest):
    def setUp(self):
        super().setUp()
        self.instance = FactoryFloor.ExtractionBatchFactory()
        self.test_url = reverse_lazy('csas2:extraction_batch_edit', args=[self.instance.pk, ])
        self.expected_template = 'csas2/form.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:extraction_batch_edit", f"/en/csas2/extractions/{self.instance.pk}/edit/", [self.instance.pk])
...
class TestFileCreateView(CommonTest):
    def setUp(self):
        super().setUp()
        self.instance = FactoryFloor.CollectionFactory()
        self.test_url = reverse_lazy('csas2:file_new', args=[self.instance.pk, ])
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:file_new", f"/en/csas2/collections/{self.instance.pk}/new-file/", [self.instance.pk])
...
class TestFileDeleteView(CommonTest):
    def setUp(self):
        ...
        self.test_url = reverse_lazy('csas2:file_delete', args=[self.instance.pk, ])
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:file_delete", f"/en/csas2/files/{self.instance.pk}/delete/", [self.instance.pk])
...
class TestFileUpdateView(CommonTest):
    def setUp(self):
        super().setUp()
        self.instance = FactoryFloor.FileFactory()
        self.test_url = reverse_lazy('csas2:file_edit', args=[self.instance.pk, ])
        self.expected_template = 'shared_models/generic_popout_form.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:file_edit", f"/en/csas2/files/{self.instance.pk}/edit/", [self.instance.pk])


class TestFiltrationBatchCreateView(CommonTest):
    def setUp(self):
        super().setUp()
        self.test_url = reverse_lazy('csas2:filtration_batch_new')
        self.expected_template = 'csas2/form.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:filtration_batch_new", f"/en/csas2/filtrations/new/")
...
class TestFiltrationBatchDeleteView(CommonTest):
    def setUp(self):
        ...
        self.test_url = reverse_lazy('csas2:filtration_batch_delete', args=[self.instance.pk, ])
        self.expected_template = 'csas2/confirm_delete.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:filtration_batch_delete", f"/en/csas2/filtrations/{self.instance.pk}/delete/", [self.instance.pk])
...
class TestFiltrationBatchDetailView(CommonTest):
    def setUp(self):
        super().setUp()
        self.instance = FactoryFloor.FiltrationBatchFactory()
        self.test_url = reverse_lazy('csas2:filtration_batch_detail', args=[self.instance.pk, ])
        self.expected_template = 'csas2/filtration_batch_detail.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:filtration_batch_detail", f"/en/csas2/filtrations/{self.instance.pk}/view/", [self.instance.pk])


class TestFiltrationBatchListView(CommonTest):
    def setUp(self):
        super().setUp()
        self.test_url = reverse_lazy('csas2:filtration_batch_list')
        self.expected_template = 'csas2/list.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:filtration_batch_list", f"/en/csas2/filtrations/")
...
class TestFiltrationBatchUpdateView(CommonTest):
    def setUp(self):
        super().setUp()
        self.instance = FactoryFloor.FiltrationBatchFactory()
        self.test_url = reverse_lazy('csas2:filtration_batch_edit', args=[self.instance.pk, ])
        self.expected_template = 'csas2/form.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:filtration_batch_edit", f"/en/csas2/filtrations/{self.instance.pk}/edit/", [self.instance.pk])


class TestPCRBatchCreateView(CommonTest):
    def setUp(self):
        super().setUp()
        self.test_url = reverse_lazy('csas2:pcr_batch_new')
        self.expected_template = 'csas2/form.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:pcr_batch_new", f"/en/csas2/pcrs/new/")
...
class TestPCRBatchDeleteView(CommonTest):
    def setUp(self):
        ...
        self.test_url = reverse_lazy('csas2:pcr_batch_delete', args=[self.instance.pk, ])
        self.expected_template = 'csas2/confirm_delete.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:pcr_batch_delete", f"/en/csas2/pcrs/{self.instance.pk}/delete/", [self.instance.pk])
...
class TestPCRBatchDetailView(CommonTest):
    def setUp(self):
        super().setUp()
        self.instance = FactoryFloor.PCRBatchFactory()
        self.test_url = reverse_lazy('csas2:pcr_batch_detail', args=[self.instance.pk, ])
        self.expected_template = 'csas2/pcr_batch_detail.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:pcr_batch_detail", f"/en/csas2/pcrs/{self.instance.pk}/view/", [self.instance.pk])


class TestPCRBatchListView(CommonTest):
    def setUp(self):
        super().setUp()
        self.test_url = reverse_lazy('csas2:pcr_batch_list')
        self.expected_template = 'csas2/list.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:pcr_batch_list", f"/en/csas2/pcrs/")
...
class TestPCRBatchUpdateView(CommonTest):
    def setUp(self):
        super().setUp()
        self.instance = FactoryFloor.PCRBatchFactory()
        self.test_url = reverse_lazy('csas2:pcr_batch_edit', args=[self.instance.pk, ])
        self.expected_template = 'csas2/form.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:pcr_batch_edit", f"/en/csas2/pcrs/{self.instance.pk}/edit/", [self.instance.pk])


class TestReportSearchFormView(CommonTest):
    def setUp(self):
        super().setUp()
        self.test_url = reverse_lazy('csas2:reports')
        self.expected_template = 'csas2/report_search.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:reports", f"/en/csas2/reports/")
...
class TestSampleCreateView(CommonTest):
    def setUp(self):
        ...
        self.test_url = reverse_lazy('csas2:sample_new', args=[self.collection.id])
        self.expected_template = 'csas2/form.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:sample_new", f"/en/csas2/collections/{self.collection.id}/new-sample/", test_url_args=[self.collection.id])
...
class TestSampleDeleteView(CommonTest):
    def setUp(self):
        ...
        self.test_url = reverse_lazy('csas2:sample_delete', args=[self.instance.pk, ])
        self.expected_template = 'csas2/confirm_delete.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:sample_delete", f"/en/csas2/samples/{self.instance.pk}/delete/", [self.instance.pk])
...
class TestSampleDetailView(CommonTest):
    def setUp(self):
        super().setUp()
        self.instance = FactoryFloor.SampleFactory()
        self.test_url = reverse_lazy('csas2:sample_detail', args=[self.instance.pk, ])
        self.expected_template = 'csas2/sample_detail.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:sample_detail", f"/en/csas2/samples/{self.instance.pk}/view/", [self.instance.pk])
...
class TestSampleUpdateView(CommonTest):
    def setUp(self):
        super().setUp()
        self.instance = FactoryFloor.SampleFactory()
        self.test_url = reverse_lazy('csas2:sample_edit', args=[self.instance.pk, ])
        self.expected_template = 'csas2/form.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:sample_edit", f"/en/csas2/samples/{self.instance.pk}/edit/", [self.instance.pk])


class TestSpeciesCreateView(CommonTest):
    def setUp(self):
        super().setUp()
        self.test_url = reverse_lazy('csas2:species_new')
        self.expected_template = 'csas2/form.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:species_new", f"/en/csas2/species/new/")
...
class TestSpeciesDeleteView(CommonTest):
    def setUp(self):
        ...
        self.test_url = reverse_lazy('csas2:species_delete', args=[self.instance.pk, ])
        self.expected_template = 'csas2/confirm_delete.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:species_delete", f"/en/csas2/species/{self.instance.pk}/delete/", [self.instance.pk])
...
class TestSpeciesDetailView(CommonTest):
    def setUp(self):
        super().setUp()
        self.instance = FactoryFloor.SpeciesFactory()
        self.test_url = reverse_lazy('csas2:species_detail', args=[self.instance.pk, ])
        self.expected_template = 'csas2/species_detail.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:species_detail", f"/en/csas2/species/{self.instance.pk}/view/", [self.instance.pk])


class TestSpeciesListView(CommonTest):
    def setUp(self):
        super().setUp()
        self.test_url = reverse_lazy('csas2:species_list')
        self.expected_template = 'csas2/list.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:species_list", f"/en/csas2/species/")
...
class TestSpeciesUpdateView(CommonTest):
    def setUp(self):
        super().setUp()
        self.instance = FactoryFloor.SpeciesFactory()
        self.test_url = reverse_lazy('csas2:species_edit', args=[self.instance.pk, ])
        self.expected_template = 'csas2/form.html'
        self.user = self.get_and_login_user(in_group="csas2_admin")
    ...
    def test_correct_url(self):
        # use the 'en' locale prefix to url
        self.assert_correct_url("csas2:species_edit", f"/en/csas2/species/{self.instance.pk}/edit/", [self.instance.pk])
