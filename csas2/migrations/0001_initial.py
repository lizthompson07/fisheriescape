    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ppt_default_section', models.ForeignKey(blank=True, help_text='When exporting CSAS processes to projects, what should be the default section to use?', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='csas_offices', to='shared_models.section', verbose_name='default section for PPT')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ManyToManyField(blank=True, limit_choices_to={'is_csas_request_tag': True}, to='shared_models.SubjectMatter', verbose_name='keyword tags')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fiscal_year', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='meetings', to='shared_models.fiscalyear', verbose_name='fiscal year of meeting')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('projects', models.ManyToManyField(blank=True, related_name='csas_processes', to='ppt.Project', verbose_name='Links to PPT Projects')),
