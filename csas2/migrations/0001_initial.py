...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('shared_models', '0011_alter_person_affiliation'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=1000, null=True, verbose_name='tittle (en)')),
                ('nom', models.CharField(blank=True, max_length=1000, null=True, verbose_name='tittle (fr)')),
                ('status', models.IntegerField(choices=[(1, 'In-progress'), (2, 'Complete'), (3, 'Deferred'), (4, 'Delayed')], default=1, verbose_name='status')),
                ...
                ('fiscal_year', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='processes', to='shared_models.fiscalyear', verbose_name='fiscal year')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'Invited'), (1, 'Accepted'), (2, 'Declined'), (3, 'Tentative'), (9, 'No response')], default=0, verbose_name='status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('type', models.IntegerField(choices=[(1, 'Meeting Minutes'), (2, 'Science Advisory Report'), (3, 'Research Document'), (4, 'Proceedings'), (5, 'Science Response'), (6, 'Working Paper')], verbose_name='type')),
                ...
                ('hide_from_list', models.BooleanField(default=False, verbose_name='This record should be hidden from the main search page')),
                ('status', models.IntegerField(choices=[(1, 'Draft'), (2, 'Submitted'), (3, 'Under review')], default=1, editable=False, verbose_name='status')),
                ('old_id', models.IntegerField(blank=True, editable=False, null=True)),
                ...
                ('meetings', models.ManyToManyField(blank=True, editable=False, related_name='documents', to='csas2.Meeting', verbose_name='csas meeting linkages')),
                ('people', models.ManyToManyField(editable=False, through='csas2.Author', to='shared_models.Person', verbose_name='authors')),
                ...
                ('series', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='csas2.series', verbose_name='series')),
