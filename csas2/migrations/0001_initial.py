# Generated by Django 3.2 on 2021-04-19 14:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=1000, null=True, verbose_name='tittle (en)')),
                ('nom', models.CharField(blank=True, max_length=1000, null=True, verbose_name='tittle (fr)')),
                ('type', models.IntegerField(choices=[(1, 'Regional'), (1, 'Zonal'), (1, 'National')], verbose_name='type')),
                ('context_text', models.TextField(blank=True, null=True, verbose_name='context')),
                ('objectives_text', models.TextField(blank=True, null=True, verbose_name='objectives')),
                ('expected_publications', models.TextField(blank=True, null=True, verbose_name='expected publications')),
                ('advisors', models.ManyToManyField(to=settings.AUTH_USER_MODEL, verbose_name='DFO Science advisors')),
                ...
                ('csas_requests', models.ManyToManyField(related_name='processes', to='csas2.CSASRequest')),
