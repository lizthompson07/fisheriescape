  ...
  methods: {
    ...
    submitProjectYear(projectYear, action) {
      if (action === "submit" || action === "unsubmit") {
        ...
        if (userInput) {
          this.project_loading = true;
          let endpoint = `/api/ppt/project-years/${projectYear.id}/${action}/`;
    ...
    getFinancials(yearId) {
      ...
      let endpoint = `/api/ppt/project-years/${yearId}/financials/`;
      apiService(endpoint)
          .then(response => {
    ...
    getProjectFinancials(projectId) {
      ...
      let endpoint = `/api/ppt/projects/${projectId}/financials/`;
      apiService(endpoint)
          .then(response => {
    ...
    getStaff(yearId) {
      ...
      let endpoint = `/api/ppt/project-years/${yearId}/staff/`;
      apiService(endpoint)
          .then(response => {
    ...
    deleteStaffMember(staffMember) {
      ...
      if (userInput1) {
        ...
        if (userInput2) {
          let endpoint = `/api/ppt/staff/${staffMember.id}/`;
    ...
    getOMCosts(yearId) {
      ...
      let endpoint = `/api/ppt/project-years/${yearId}/om-costs/`;
      apiService(endpoint)
          .then(response => {
    ...
    deleteOMCost(OMCost) {
      ...
      if (userInput) {
        let endpoint = `/api/ppt/om-costs/${OMCost.id}/`;
        apiService(endpoint, "DELETE")
            .then(response => {
    ...
    addAllOMCosts() {
      if (this.projectYear.id) {
        this.om_cost_loading = true;
        let endpoint = `/api/ppt/project-years/${this.projectYear.id}/add-all-costs/`;
        apiService(endpoint, "POST")
            .then(response => {
              this.om_cost_loading = false;
              this.om_costs = response;
    ...
    clearEmptyOMCosts() {
      if (this.projectYear.id) {
        this.om_cost_loading = true;
        let endpoint = `/api/ppt/project-years/${this.projectYear.id}/remove-empty-costs/`;
        apiService(endpoint, "POST")
            .then(response => {
              this.om_cost_loading = false;
              this.om_costs = response;
    ...
    getCapitalCosts(yearId) {
      ...
      let endpoint = `/api/ppt/project-years/${yearId}/capital-costs/`;
      apiService(endpoint)
          .then(response => {
    ...
    deleteCapitalCost(capitalCost) {
      ...
      if (userInput) {
        let endpoint = `/api/ppt/capital-costs/${capitalCost.id}/`;
        apiService(endpoint, "DELETE")
            .then(response => {
    ...
    getActivities(yearId) {
      ...
      let endpoint = `/api/ppt/project-years/${yearId}/activities/`;
      apiService(endpoint)
          .then(response => {
    ...
    deleteActivity(activity) {
      ...
      if (userInput) {
        let endpoint = `/api/ppt/activities/${activity.id}/`;
        apiService(endpoint, "DELETE")
            .then(response => {
    ...
    getCollaborations(yearId) {
      ...
      let endpoint = `/api/ppt/project-years/${yearId}/collaborations/`;
      apiService(endpoint)
          .then(response => {
    ...
    deleteCollaboration(collaboration) {
      ...
      if (userInput) {
        let endpoint = `/api/ppt/collaborations/${collaboration.id}/`;
        apiService(endpoint, "DELETE")
            .then(response => {
    ...
    getStatusReports(yearId) {
      ...
      let endpoint = `/api/ppt/project-years/${yearId}/status-reports/`;
      apiService(endpoint)
          .then(response => {
    ...
    deleteStatusReport(statusReport) {
      ...
      if (userInput) {
        let endpoint = `/api/ppt/status-reports/${statusReport.id}/`;
        apiService(endpoint, "DELETE")
            .then(response => {
    ...
    getFiles(yearId) {
      ...
      let endpoint = `/api/ppt/project-years/${yearId}/files/`;
      apiService(endpoint)
          .then(response => {
    ...
    getActivityMetadata() {
      let endpoint = `/api/ppt/meta/models/activity/`;
    ...
    getOMCostMetadata() {
      let endpoint = `/api/ppt/meta/models/om-cost/`;
      apiService(endpoint).then(data => {
