...
class TestActivityListCreateAPIView(CommonTest):
    def setUp(self):
        ...
        self.test_url = reverse("ppt-activity-list", args=[self.instance.pk])

    @tag("api", 'activity-list')
    def test_url(self):
        self.assert_correct_url("ppt-activity-list", test_url_args=[self.instance.pk],
                                expected_url_path=f"/api/ppt/project-years/{self.instance.pk}/activities/")
...
class TestCapitalCostListCreateAPIView(CommonTest):
    def setUp(self):
        ...
        self.test_url = reverse("ppt-capital-list", args=[self.instance.pk])

    @tag("api", 'capital-cost')
    def test_url(self):
        self.assert_correct_url("ppt-capital-list", test_url_args=[self.instance.pk],
                                expected_url_path=f"/api/ppt/project-years/{self.instance.pk}/capital-costs/")
...
class TestCollaborationListCreateAPIView(CommonTest):
    def setUp(self):
        ...
        self.test_url = reverse("ppt-collaboration-list", args=[self.instance.pk])

    @tag("api", 'collaboration-list')
    def test_url(self):
        self.assert_correct_url("ppt-collaboration-list", test_url_args=[self.instance.pk],
                                expected_url_path=f"/api/ppt/project-years/{self.instance.pk}/collaborations/")
...
class TestCurrentUser(CommonTest):
    def setUp(self):
        super().setUp()
        self.user = self.get_and_login_user()
        self.test_url = reverse("ppt-current-user")

    @tag("api", 'current-project-user')
    def test_url(self):
        self.assert_correct_url("ppt-current-user", expected_url_path=f"/api/ppt/user/")
...
class TestFileListCreateAPIView(CommonTest):
    def setUp(self):
        ...
        self.test_url = reverse("ppt-file-list", args=[self.instance.pk])

    @tag("api", 'file-list')
    def test_url(self):
        self.assert_correct_url("ppt-file-list", test_url_args=[self.instance.pk],
                                expected_url_path=f"/api/ppt/project-years/{self.instance.pk}/files/")
...
#         self.test_url = reverse("ppt-review-list", args=[self.instance.pk])
#
#     @tag("api", 'review-list')
#     def test_url(self):
#         self.assert_correct_url("ppt-review-list", test_url_args=[self.instance.pk],
#                                 expected_url_path=f"/api/ppt/project-years/{self.instance.pk}/reviews/")
#
#     @tag("api", 'review-list')
#     def test_get(self):
#         # PERMISSIONS
...
class TestFTEBreakdownAPIView(CommonTest):
    def setUp(self):
        super().setUp()
        self.user = self.get_and_login_user()
        self.test_url = reverse("ppt-fte-breakdown", args=None)

    @tag("api", 'fte-breakdown')
    def test_url(self):
        self.assert_correct_url("ppt-fte-breakdown", test_url_args=None, expected_url_path=f"/api/ppt/fte-breakdown/")
...
class TestOMCostListCreateAPIView(CommonTest):
    def setUp(self):
        ...
        self.test_url = reverse("ppt-om-list", args=[self.instance.pk])

    @tag("api", 'om-list')
    def test_url(self):
        self.assert_correct_url("ppt-om-list", test_url_args=[self.instance.pk],
                                expected_url_path=f"/api/ppt/project-years/{self.instance.pk}/om-costs/")
...
class TestProjectListAPIView(CommonTest):
    def setUp(self):
        ...
        self.test_url = reverse("ppt-project-list", args=None)

    @tag("api", 'project-list')
    def test_url(self):
        self.assert_correct_url("ppt-project-list", test_url_args=None, expected_url_path=f"/api/ppt/projects/")
...
class TestProjectRetrieveAPIView(CommonTest):
    def setUp(self):
        ...
        self.user = self.get_and_login_user()
        self.instance = FactoryFloor.ProjectFactory()
        self.test_url = reverse("ppt-project-detail", args=[self.instance.pk])

    @tag("api", 'project-detail')
    def test_url(self):
        self.assert_correct_url("ppt-project-detail", test_url_args=[self.instance.pk], expected_url_path=f"/api/ppt/projects/{self.instance.pk}/")
...
class TestProjectYearListAPIView(CommonTest):
    def setUp(self):
        ...
        self.test_url = reverse("ppt-year-list", args=None)

    @tag("api", 'year-list')
    def test_url(self):
        self.assert_correct_url("ppt-year-list", test_url_args=None, expected_url_path=f"/api/ppt/project-years/")
...
class TestProjectYearRetrieveAPIView(CommonTest):
    def setUp(self):
        ...
        self.user = self.get_and_login_user()
        self.instance = FactoryFloor.ProjectYearFactory()
        self.test_url = reverse("ppt-year-detail", args=[self.instance.pk])

    @tag("api", 'year-detail')
    def test_url(self):
        self.assert_correct_url("ppt-year-detail", test_url_args=[self.instance.pk], expected_url_path=f"/api/ppt/project-years/{self.instance.pk}/")
...
class TestProjectYearSubmitAPIView(CommonTest):
    def setUp(self):
        ...
        self.test_url = reverse("ppt-year-submit", args=[self.instance.pk])

    @tag("api", 'year-submit')
    def test_url(self):
        self.assert_correct_url("ppt-year-submit", test_url_args=[self.instance.pk],
                                expected_url_path=f"/api/ppt/project-years/{self.instance.pk}/submit/")
...
class TestProjectYearUnsubmitAPIView(CommonTest):
    def setUp(self):
        ...
        self.test_url = reverse("ppt-year-unsubmit", args=[self.instance.pk])

    @tag("api", 'year-unsubmit')
    def test_url(self):
        self.assert_correct_url("ppt-year-unsubmit", test_url_args=[self.instance.pk],
                                expected_url_path=f"/api/ppt/project-years/{self.instance.pk}/unsubmit/")
...
class TestStaffListCreateAPIView(CommonTest):
    def setUp(self):
        ...
        self.staff = FactoryFloor.LeadStaffFactory()
        self.instance = self.staff.project_year
        self.test_url = reverse("ppt-staff-list", args=[self.instance.pk])

    @tag("api", 'staff-list')
    def test_url(self):
        self.assert_correct_url("ppt-staff-list", test_url_args=[self.instance.pk],
                                expected_url_path=f"/api/ppt/project-years/{self.instance.pk}/staff/")
...
class TestStatusReportListCreateAPIView(CommonTest):
    def setUp(self):
        ...
        self.test_url = reverse("ppt-status-report-list", args=[self.instance.pk])

    @tag("api", 'status-report-list')
    def test_url(self):
        self.assert_correct_url("ppt-status-report-list", test_url_args=[self.instance.pk],
                                expected_url_path=f"/api/ppt/project-years/{self.instance.pk}/status-reports/")
