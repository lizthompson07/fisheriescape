...
class StaffEmail:
    ...
    def load_html_template(self, staff, action):
        t = loader.get_template('ppt/emails/staff_change.html')
...
class ProjectApprovalEmail:
    ...
    def load_html_template(self, review):
        t = loader.get_template('ppt/emails/email_project_approved.html')
...
class ProjectYearSubmissionEmail:
    ...
    def load_html_template(self, object):
        t = loader.get_template('ppt/emails/email_project_submitted.html')
