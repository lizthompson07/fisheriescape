    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allotment_code', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='projects_ppt', to='shared_models.allotmentcode', verbose_name='allotment code (if known)')),
                ...
                ('responsibility_center', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='projects_ppt', to='shared_models.responsibilitycenter', verbose_name='responsibility center (if known)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_year', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='reports', to='ppt.projectyear')),
            ],
            options={
                'ordering': ['created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='files', to='ppt.project')),
