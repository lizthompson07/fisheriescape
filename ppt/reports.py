...
def generate_acrdp_application(project):
    ...
    template_file_path = os.path.join(settings.BASE_DIR, 'ppt', 'static', "ppt", "acrdp_template.docx")
...
def generate_sar_workplan(year, region):
    ...
    template_file_path = os.path.join(settings.BASE_DIR, 'ppt', 'static', "ppt", "sar_workplan_template.xlsx")
...
def generate_acrdp_budget(project):
    ...
    template_file_path = os.path.join(settings.BASE_DIR, 'ppt', 'static', "ppt", "acrdp_template.xlsx")
...
def generate_csrf_submission_list(year, region):
    ...
    template_file_path = os.path.join(settings.BASE_DIR, 'ppt', 'static', "ppt", "csrf_regional_submissions_template.xlsx")
...
def generate_csrf_application(project, lang):
    ...
    if lang == "fr":
        template_file_path = os.path.join(settings.BASE_DIR, 'ppt', 'static', "ppt", "csrf_template_fr.docx")
    else:
        template_file_path = os.path.join(settings.BASE_DIR, 'ppt', 'static', "ppt", "csrf_template_en.docx")
...
def generate_sara_application(project, lang):
    ...
    if lang == "fr":
        template_file_path = os.path.join(settings.BASE_DIR, 'ppt', 'static', "ppt", "sara_template.docx")
    else:
        template_file_path = os.path.join(settings.BASE_DIR, 'ppt', 'static', "ppt", "sara_template.docx")
...
def export_project_summary(request):
    ...
    template_file_path = os.path.join(settings.BASE_DIR, 'ppt', 'static', "ppt", "projects_summary_template.xlsx")
