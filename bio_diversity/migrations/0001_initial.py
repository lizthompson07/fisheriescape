# Generated by Django 3.2.4 on 2021-06-16 18:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manufacturer', models.CharField(db_column='MANUFACTURER', max_length=35, verbose_name='Maufacturer')),
                ('inservice_date', models.DateField(db_column='INSERVICE_DATE', verbose_name='Date unit was put into service')),
                ('serial_number', models.CharField(db_column='SERIAL_NUMBER', max_length=50, verbose_name='Serial Number')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.CharField(max_length=32, verbose_name='Created By')),
                ('created_date', models.DateField(verbose_name='Created Date')),
                ('loc_lat', models.DecimalField(blank=True, db_column='LATITUDE', decimal_places=5, max_digits=7, null=True, verbose_name='Latitude')),
                ('loc_lon', models.DecimalField(blank=True, db_column='LONGITUDE', decimal_places=5, max_digits=8, null=True, verbose_name='Longitude')),
                ('end_lat', models.DecimalField(blank=True, db_column='END_LATITUDE', decimal_places=5, max_digits=7, null=True, verbose_name='End Latitude')),
                ('end_lon', models.DecimalField(blank=True, db_column='END_LONGITUDE', decimal_places=5, max_digits=8, null=True, verbose_name='End Longitude')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.CharField(max_length=32, verbose_name='Created By')),
                ('created_date', models.DateField(verbose_name='Created Date')),
                ('samp_num', models.IntegerField(db_column='SAMPLE_FISHNO', verbose_name='Sample Fish Number')),
                ('comments', models.CharField(blank=True, db_column='COMMENTS', max_length=2000, null=True, verbose_name='Comments')),
                ...
                ('loc_id', models.ForeignKey(blank=True, db_column='LOCATION_ID', null=True, on_delete=django.db.models.deletion.CASCADE, to='bio_diversity.location', verbose_name='Location')),
            ],
        ),
        migrations.CreateModel(
            name='SampleCode',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.CharField(blank=True, db_column='COMMENTS', max_length=2000, null=True, verbose_name='Comments')),
                ('indv_id', models.ForeignKey(db_column='UFID', limit_choices_to={'indv_valid': True, 'pit_tag__isnull': False}, on_delete=django.db.models.deletion.CASCADE, related_name='sires', to='bio_diversity.individual', verbose_name='Sire')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.CharField(max_length=32, verbose_name='Created By')),
                ('created_date', models.DateField(verbose_name='Created Date')),
                ('min_lat', models.DecimalField(blank=True, db_column='MIN_LATITUDE', decimal_places=5, max_digits=7, null=True, verbose_name='Min Latitude')),
                ('max_lat', models.DecimalField(blank=True, db_column='MAX_LATITUDE', decimal_places=5, max_digits=7, null=True, verbose_name='Max Latitude')),
                ('min_lon', models.DecimalField(blank=True, db_column='MIN_LONGITUDE', decimal_places=5, max_digits=8, null=True, verbose_name='Min Longitude')),
                ('max_lon', models.DecimalField(blank=True, db_column='MAX_LONGITUDE', decimal_places=5, max_digits=8, null=True, verbose_name='Max Longitude')),
        ...
        migrations.AddField(
            ...
            name='locdc_id',
            field=models.ForeignKey(db_column='LOC_DET_ID', on_delete=django.db.models.deletion.CASCADE, to='bio_diversity.locationdetcode', verbose_name='Location detail code'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='ldsc_id',
            field=models.ForeignKey(blank=True, db_column='LOC_DET_SUBJ_ID', null=True, on_delete=django.db.models.deletion.CASCADE, to='bio_diversity.locdetsubjcode', verbose_name='Location Detail Subjective Code'),
        ),
        migrations.AddField(
            model_name='locationdet',
            name='loc_id',
            field=models.ForeignKey(db_column='LOCATION_ID', on_delete=django.db.models.deletion.CASCADE, related_name='loc_dets', to='bio_diversity.location', verbose_name='Location'),
        ),
        migrations.AddField(
            model_name='locationdet',
            name='locdc_id',
        ...
        migrations.AddField(
            ...
            name='anix_id',
            field=models.ForeignKey(db_column='ANI_DET_XREF_ID', on_delete=django.db.models.deletion.CASCADE, related_name='individual_treatments', to='bio_diversity.anidetailxref', verbose_name='Animal Detail Cross Reference'),
        ),
        migrations.AddField(
            model_name='indtreatment',
            name='indvtc_id',
