# Generated by Django 3.1.2 on 2021-02-26 14:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.CharField(blank=True, max_length=2000, null=True, verbose_name='Comments')),
                ('indv_id', models.ForeignKey(limit_choices_to={'indv_valid': True, 'pit_tag__isnull': False}, on_delete=django.db.models.deletion.CASCADE, related_name='sires', to='bio_diversity.individual', verbose_name='Sire UFID')),
                ('pair_id', models.ForeignKey(limit_choices_to={'valid': True}, on_delete=django.db.models.deletion.CASCADE, related_name='sire', to='bio_diversity.pairing', verbose_name='Pairing')),
