# Generated by Django 3.2 on 2021-05-17 13:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loc_id', models.ForeignKey(db_column='LOCATION_ID', on_delete=django.db.models.deletion.CASCADE, to='bio_diversity.location', verbose_name='Location')),
                ('locdc_id', models.ForeignKey(db_column='LOC_DET_ID', on_delete=django.db.models.deletion.CASCADE, to='bio_diversity.locationdetcode', verbose_name='Location Detail Code')),
