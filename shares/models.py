...
class Server(models.Model):
    ...
    server_type = models.IntegerField(choices=COUNTRY_CHOICES, verbose_name=_("server type"))
...
class User(models.Model):
    ...
    notes = models.TextField(blank=True, null=True, verbose_name=_("notes"))
    flag_for_deletion = models.BooleanField(default=False, verbose_name=_("flag for deletion"))
