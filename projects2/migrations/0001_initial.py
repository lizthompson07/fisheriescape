    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Start date of project')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('risk_description', models.TextField(blank=True, null=True, verbose_name='Description of risks and their consequences (ACRDP)')),
                ('impact', models.IntegerField(blank=True, choices=[(1, '1-Negligible'), (2, '2-Low'), (3, '3-Medium'), (4, '4-High'), (5, '5-Extreme')], null=True, verbose_name='what will be the impact if the risks occurs (ACRDP)')),
                ('likelihood', models.IntegerField(blank=True, choices=[(1, '1-Very unlikely'), (2, '2-Unlikely'), (3, '3-Low'), (4, '4-Likely'), (5, '5-Almost certain')], null=True, verbose_name='what is the likelihood of the risks occurring (ACRDP)')),
                ('risk_rating', models.IntegerField(blank=True, choices=[(None, 'n/a'), (1, 'Low'), (2, 'Medium'), (3, 'High')], editable=False, null=True)),
                ('mitigation_measures', models.TextField(blank=True, null=True, verbose_name='what measures will be used to mitigate the risks (ACRDP)')),
