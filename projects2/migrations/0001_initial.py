...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='project',
            name='tags',
            field=models.ManyToManyField(blank=True, related_name='projects', to='projects2.Tag', verbose_name='Tags / keywords (used for searching)'),
        ),
        migrations.CreateModel(
            name='OMCost',
            fields=[
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='funding_sources', to='projects2.fundingsourcetype'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='collaborators', to='projects2.project', verbose_name='project')),
