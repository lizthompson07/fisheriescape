...
class OMCostFilter(django_filters.FilterSet):
    ...
    region_name = django_filters.CharFilter(field_name='project_year__project__section__division__branch__region__name__icontains', label=_("Project"), widget=forms.NumberInput())