...
class DataAsset(models.Model):
    ...
    metadata_maturity = models.CharField(max_length=255, null=True, verbose_name="Metadata Maturity")
    data_quality_rating = models.CharField(max_length=255, null=True, verbose_name="Data Quality Rating")
    naming_conventions = models.CharField(max_length=255, null=True, verbose_name="Naming Conventions")
