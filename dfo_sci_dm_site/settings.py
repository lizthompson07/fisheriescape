"""
Django settings for dfo_sci_dm_site project.
...
ROOT_URLCONF = 'dfo_sci_dm_site.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'dfo_sci_dm_site.context_processor.my_envr'
            ],
        },
    },
]

WSGI_APPLICATION = 'dfo_sci_dm_site.wsgi.application'
