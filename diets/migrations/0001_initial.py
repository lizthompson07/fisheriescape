# Generated by Django 2.1.4 on 2019-03-26 15:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stomach_id', models.CharField(blank=True, max_length=10, null=True, verbose_name='stomach ID')),
                ...
                ('cruise', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='predators', to='shared_models.Cruise')),
