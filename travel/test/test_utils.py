...
class UtilsTest(CommonTest):
    ...
    def test_search_and_replace(self):
        ...
        TravellerFactory(user=user2)
        ReviewerFactory(user=user2)
        TripReviewerFactory(user=user2)
        ...
        self.assertEqual(user2.travellers.count(), 1)
        self.assertEqual(user2.reviewers.count(), 1)
        self.assertEqual(user2.trip_reviewers.count(), 1)
        utils.search_and_replace(user2, user1)
        ...
        self.assertEqual(user2.travellers.count(), 4)
        self.assertEqual(user2.reviewers.count(), 3)
        self.assertEqual(user2.trip_reviewers.count(), 2)
