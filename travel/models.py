...
#         return reverse('travel:server_detail', kwargs={'pk': self.id})
#
#
...
#
#     def get_absolute_url(self):
#         return reverse('travel:user_detail', kwargs={'pk': self.id})
#
#
# class Share(models.Model):
#     name = models.CharField(max_length=200, verbose_name=_("name"))
#     server = models.ForeignKey(Server, on_delete=models.CASCADE, related_name="travel")
...
#     notes = models.TextField(blank=True, null=True, verbose_name=_("notes"))
#     users = models.ManyToManyField(User, related_name="travel", blank=True)
#
#     def __str__(self):
...
#
#     def get_absolute_url(self):
#         return reverse('travel:share_detail', kwargs={'pk': self.id})
