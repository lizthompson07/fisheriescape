...
urlpatterns = [
    ...
    path('trips/approval/', views.TripApprovalListView.as_view(), name="trip_approval_list"),
    path('trips/approval/<str:which_ones>/', views.TripApprovalListView.as_view(), name="trip_approval_list"),
