...
def export_org_report(request):
    ...
    for obj in models.Section.objects.all():
        data_row = [
            ...
            obj.division.branch.region.head.id if obj.division.branch.region.head else None,
            obj.division.branch.region.head.email if obj.division.branch.region.head else None,
            obj.division.branch.region.head.get_full_name() if obj.division.branch.region.head else None,
            obj.division.branch.region.admin.id if obj.division.branch.region.admin else None,
            obj.division.branch.region.admin.email if obj.division.branch.region.admin else None,
            obj.division.branch.region.admin.get_full_name() if obj.division.branch.region.admin else None,
            obj.division.branch.uuid,
            obj.division.branch.name,
            obj.division.branch.nom,
            obj.division.branch.head.id if obj.division.branch.head else None,
            obj.division.branch.head.email if obj.division.branch.head else None,
            obj.division.branch.head.get_full_name() if obj.division.branch.head else None,
            obj.division.branch.admin.id if obj.division.branch.admin else None,
            obj.division.branch.admin.email if obj.division.branch.admin else None,
            obj.division.branch.admin.get_full_name() if obj.division.branch.admin else None,
            obj.division.uuid,
            obj.division.name,
            obj.division.nom,
            obj.division.head.id if obj.division.head else None,
            obj.division.head.email if obj.division.head else None,
            obj.division.head.get_full_name() if obj.division.head else None,
            obj.division.admin.id if obj.division.admin else None,
            obj.division.admin.email if obj.division.admin else None,
            obj.division.admin.get_full_name() if obj.division.admin else None,
            obj.uuid,
            obj.name,
            obj.nom,
            obj.head.id if obj.head else None,
            obj.head.email if obj.head else None,
            obj.head.get_full_name() if obj.head else None,
            obj.admin.id if obj.admin else None,
            obj.admin.email if obj.admin else None,
            obj.admin.get_full_name() if obj.admin else None,
        ]
