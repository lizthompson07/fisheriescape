...
from pacificsalmondatahub.models import DataGlossary
...
def clear():
    toDelete = DataGlossary.objects.all()
    toDelete.delete()
...
def run():
    ...
    # with open(os.path.join(rootdir, 'CSV/PacificSalmonDataGlossary.csv'), 'r') as csvfile:
