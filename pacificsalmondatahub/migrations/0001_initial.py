    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('InventoryID', models.ManyToManyField(to='pacificsalmondatahub.DataInventory')),
            ],
        ),
        migrations.CreateModel(
            name='Glossary',
            fields=[
                ...
                ('Inventory_ID', models.ManyToManyField(to='pacificsalmondatahub.DataInventory')),
            ],
        ),
        migrations.CreateModel(
            name='Comments',
            fields=[
                ...
                ('Inventory_ID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pacificsalmondatahub.datainventory')),
            ],
        ),
    ]
