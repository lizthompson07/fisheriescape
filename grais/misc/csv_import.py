...
def seed_biofouling_samples_deployments():
    ...
    with open(os.path.join(rootdir, "qry_samples.csv"), 'r') as csv_read_file:
        ...
        for row in my_csv:
            ...
            deployment_date = datetime.datetime.strptime(my_date_time, "%m/%d/%Y %H:%M")
...
def seed_biofouling_samples_retrievals():
    ...
    with open(os.path.join(rootdir, "qry_samples.csv"), 'r') as csv_read_file:
        ...
        for row in my_csv:
            ...
            retrev_date = datetime.datetime.strptime(my_date_time, "%m/%d/%Y %H:%M")
