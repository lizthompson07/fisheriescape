...
class SampleFilter(django_filters.FilterSet):
    ...
    LastModifiedDate= django_filters.DateFilter(field_name='last_modified_date', label="Last Modified", lookup_expr='startswith', widget= forms.DateInput(attrs={'type': 'date',}))
