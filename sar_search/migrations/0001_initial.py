# Generated by Django 2.2.2 on 2019-10-23 14:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('used_for', models.IntegerField(choices=[(1, 'SARA / COSEWIC'), (2, 'Nova Scotia'), (3, 'New Brunswick'), (4, 'Prince Edward Island'), (5, 'IUCN Red List')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cosewic_status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='cosewic_spp', to='sar_search.SpeciesStatus', verbose_name='SARA status')),
                ('iucn_red_list_status', models.ForeignKey(blank=True, limit_choices_to={'used_for': 5}, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='iucn_spp', to='sar_search.SpeciesStatus', verbose_name='IUCN Red Flag status')),
                ...
                ('pe_status', models.ForeignKey(blank=True, limit_choices_to={'used_for': 4}, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='pe_spp', to='sar_search.SpeciesStatus', verbose_name='PEI status')),
                ...
                ('sara_status', models.ForeignKey(blank=True, limit_choices_to={'used_for': 1}, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='sara_spp', to='sar_search.SpeciesStatus', verbose_name='COSEWIC status')),
