...
def get_date_range_overlap(d0_start, d0_end, d1_start, d1_end):
    ...
    d0_start = datetime(1990, 1, 1) if not d0_start else d0_start
    d1_start = datetime(1990, 1, 1) if not d1_start else d1_start
    d0_end = datetime(2200, 1, 1) if not d0_end else d0_end
    d1_end = datetime(2200, 1, 31) if not d1_end else d1_end
