# Generated by Django 2.2.2 on 2020-05-19 12:18
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('projects', '0007_auto_20200409_1718'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(blank=True, null=True, verbose_name='Meeting Start Date')),
                ('end_date', models.DateField(blank=True, null=True, verbose_name='Meeting End Date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lead_region', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='csas.MyRegion', verbose_name='Lead Region')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='csas.MyRegion')),
            ],
        ),
        migrations.CreateModel(
            name='PurOtherRegion',
            fields=[
                ...
                ('reg_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='csas.MyRegion')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link_en', models.CharField(max_length=255, verbose_name='Link (English)')),
                ('link_fr', models.CharField(max_length=255, verbose_name='Link (French)')),
                ('attachment_en', models.CharField(max_length=255, verbose_name='Attachment (English)')),
                ('attachment_fr', models.CharField(max_length=255, verbose_name='Attachment (French)')),
        ...
        migrations.AddField(
            ...
            name='lead_region',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, to='csas.MyRegion', verbose_name='Lead Region'),
        ),
        migrations.AddField(
            model_name='metmeeting',
            name='location',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='csas.LocLocation', verbose_name='Meeting Location'),
        ),
        migrations.AddField(
            model_name='metmeeting',
            name='other_region',
            field=models.ManyToManyField(blank=True, related_name='other_regions', to='csas.MyRegion', verbose_name='Other Regions'),
        ),
        migrations.AddField(
            model_name='metmeeting',
            name='process_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='csas.AptAdvisoryProcessType', verbose_name='Type of Advisory Process'),
        ),
        migrations.AddField(
            model_name='metmeeting',
            name='program_contact',
            field=models.ManyToManyField(blank=True, related_name='program_contacts', to='csas.ConContact', verbose_name='Program Contact(s)'),
        ),
        migrations.AddField(
            model_name='metmeeting',
            name='quarter',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='csas.MeqQuarter', verbose_name='Meeting Quarter'),
        ),
        migrations.AddField(
            model_name='metmeeting',
            name='scope',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('meeting', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='csas.MetMeeting')),
                ('region', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='csas.MyRegion')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='concontact',
            name='region',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='csas.MyRegion', verbose_name='Region'),
        ),
        migrations.AddField(
            model_name='concontact',
            name='role',
