# Generated by Django 2.2.2 on 2020-05-06 05:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('csas_contact', models.ManyToManyField(blank=True, related_name='csas_contacts', to='csas.ConContact', verbose_name='CSAS Contact')),
                ...
                ('other_region', models.ManyToManyField(blank=True, related_name='other_regions', to='shared_models.Region', verbose_name='Other Region')),
                ...
                ('program_contact', models.ManyToManyField(blank=True, related_name='program_contacts', to='csas.ConContact', verbose_name='Program Contact')),
