...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title_en', models.CharField(max_length=255, verbose_name='Publication Title (English)')),
                ('title_fr', models.CharField(max_length=255, verbose_name='Publication Title (French)')),
                ('title_in', models.CharField(max_length=255, verbose_name='Publication Title (Inuktitut)')),
                ...
                ('lead_region', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, to='csas.MyRegion', verbose_name='Lead Region')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='csas.MyRegion', verbose_name='Region')),
            ],
            options={
                'ordering': ['-id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meeting', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='csas.MetMeeting')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meeting', models.ManyToManyField(blank=True, related_name='meeting', to='csas.MetMeeting', verbose_name='Meeting')),
        ...
        migrations.AddField(
            model_name='metmeeting',
            name='location',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='csas.LocLocation', verbose_name='Location'),
        ),
        migrations.AddField(
            model_name='metmeeting',
            name='other_region',
