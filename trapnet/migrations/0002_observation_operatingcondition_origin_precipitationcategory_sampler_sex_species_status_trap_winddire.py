    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operating_condition', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='traps', to='river.OperatingCondition')),
                ('precipitation_category', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='traps', to='river.PrecipitationCategory')),
                ('samplers', models.ManyToManyField(blank=True, to='river.Sampler')),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='traps', to='river.RiverSite')),
                ('wind_direction', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='traps', to='river.WindDirection')),
                ('wind_speed', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='traps', to='river.WindSpeed')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('origin', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='observations', to='river.Origin')),
                ('sex', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='observations', to='river.Sex')),
                ('species', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='observations', to='river.Species')),
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='observations', to='river.Status')),
                ('trap', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='observations', to='river.Trap')),
            ],
            options={
