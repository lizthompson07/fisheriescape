# Generated by Django 3.1.2 on 2021-01-25 13:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dfo_contact_instructions', models.TextField(blank=True, null=True, verbose_name='DFO contacts')),
                ...
                ('grouping', models.ManyToManyField(to='masterlist.Grouping', verbose_name='grouping')),
                ...
                ('regions', models.ManyToManyField(blank=True, to='shared_models.Region', verbose_name='regions')),
            ],
            options={
                'ordering': ['name_eng'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('to_cc', models.IntegerField(choices=[(1, 'TO'), (2, 'CC'), (3, 'CC (Commercial Only)')], verbose_name='TO / CC')),
                ('date_last_modified', models.DateTimeField(auto_now=True, verbose_name='date last modified')),
                ('last_modified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL, verbose_name='last modified by')),
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='consultation_roles', to='masterlist.organizationmember')),
